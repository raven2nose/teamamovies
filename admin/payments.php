...
<head>
  ...
  <title>TeamAMovie - Admin | Payments</title>
                                ...
                                if($result->num_rows>0){
                                    ...
                                    while($row=$result->fetch_assoc()){
                                        ...
                                        echo "<tr style='text-align:center;'>";
                                            ...
                                            echo "</td>";
                                            echo "<td style='vertical-align:middle'>RMB ".number_format((float)$row['sub_total'], 2, '.', '')."</td>";
                                            echo "<td style='vertical-align:middle'>RMB ".number_format((float)$row['service_tax'], 2, '.', '')."</td>";
                                            echo "<td style='vertical-align:middle'>RMB ".number_format((float)$row['paid_amount'], 2, '.', '')."</td>";
                                        echo "</tr>";
                                    }
                                }else{

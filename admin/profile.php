...
<body class="grey lighten-4">
  ...
  <header>
    ...
    <div class="sidebar-fixed position-fixed">
      ...
      <div class="logo-wrapper-custom">
        <img src="images/logo.png" width="30px" height="30px" class="img-fluid" alt="TeamAMovie Private Limited"> TeamAMovie
      </div>
  ...
  <footer class="page-footer text-center font-small grey darken-4 mt-4 fixed-bottom">
    ...
    <div class="footer-copyright py-3">
      <font color="white">© 2019 TeamAMovie. All Rights Reserved. Site by <font color="yellow">GenetriX.</font></font>
    </div>
    <!--/.Copyright-->

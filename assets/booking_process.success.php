...
<div class="content">
    ...
    <hr>
    <div style="margin-bottom:15px; color:#5c5c5c">Your browser will automatically redirect to TeamAMovies homepage in <span id="timer" style="font-weight:bold"></span> seconds.</div>
    <p>

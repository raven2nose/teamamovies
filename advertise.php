  ...
  <body>
    ...
    <div class="advertise">
        ...
        <div class="container mt-4" style="line-height:22px; font-size: 14px; color: #606978; font-family:sans-serif">
            ...
            <div>
							<p>TeamAMovie offers commercial advertising at all its cinemas and as well as on its corproate web portal that is online ticket booking enabled.</p>
							<div class="cinema_advertising">
								...
								<div class="details_wrapper" style="padding-top:15px">
									<p>Unlimited indoor advertising as well as limited outdoor advertising opportunities exist at all Theaters that are managed and operated by TeamAMovie.</p>
									<p>The following benefits are being offered for its valuable customers for carrying out promotional campaigns by TeamAMovie.</p>
									<p>Screening of Commercials / Slide at Movie</p>
									<p>E.g. for an investment of RMB 75,00/- + NBT + VAT you can enjoy 1 x 30 sec Commercial per Movie for a period of one month. (4 Shows x 30 days per month) = 120 spots per month</p>
									...
									<br/>
									<p><strong>Why advertise with TeamAMovie?</strong></p>
									<p>TeamAMovie is the market leader and has more than 5.5 Mn customer base</p>
							...
							<div class="web_portal_advertising">
								...
								<div class="details_wrapper" style="padding-top:15px">
									<p>Commercial advertising is available on the TeamAMovie' online web portal (This website) - www.teamamovie.kz. At present the following banner positions are available:</p>
									...
									<p>Telephone : +70 123 123 123</p>
									
									<p>E-mail : <a style="color:#ee1a03; text-decoration:none" href="mailto:raven2nose@gmail.com">marketing@teamamovie.com</a><br/><br/><br/></p>
								</div>
							</div>
